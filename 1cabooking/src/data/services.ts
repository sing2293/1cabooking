    ...
    packages: [
      {
        ...
        description: {
          en: 'The ultimate standard of care. This package provides Total Air Management by combining the critical three-point circuit (Ducts, Blower, Coils) with deep cleaning of the Air Exchanger, Dryer Vent, and bathroom exhaust systems, ensuring maximum safety and cleanliness throughout the entire structure.',
          fr: 'La norme ultime de soin. Ce forfait offre une gestion totale de l\'air en combinant le circuit tripoint critique (conduits, soufflante, bobines) avec le nettoyage en profondeur de l\'échangeur d\'air, du sèche-linge et des ventilateurs de salle de bain.',
        },
        includes: [
